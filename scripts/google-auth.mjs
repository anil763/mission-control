...
// Run with your credentials as env vars:
// GOOGLE_CLIENT_ID=xxx GOOGLE_CLIENT_SECRET=xxx node scripts/google-auth.mjs
...
const server = createServer(async (req, res) => {
  ...
  if (tokens.refresh_token) {
    console.log("\n✅ Refresh token obtained. Add to .env.local:");
